...
<h3>Kontakt:</h3>
<p><?php echo $this->Html->image("/img/imprint-contact.png") ?></p>
...
<p>Es wurden Inhalte/Frameworks aus den folgenden Quellen verwendet:
	<ul>
		<li>
			<a href="http://cakephp.org/">CakePHP</a> (<a href="http://opensource.org/licenses/MIT">MIT license</a>)
		</li>
		<li>
		...
		<li>
			<a href="http://canvasjs.com/">CanvasJS</a> (<a href="http://creativecommons.org/licenses/by-nc/3.0/deed.en_US">Creative Commons Attribution-NonCommercial 3.0</a>)
		</li>
	</ul>
</p>
...
<p>Copyright 2013-2014 Kai Lehmann</p>

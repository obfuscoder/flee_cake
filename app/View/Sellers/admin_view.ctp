...
<h3>Aktionen</h3>
<p class="actions">
	<?php echo $this->Html->buttonLink("Bearbeiten", array("action" => "edit", $seller["Seller"]["id"])); ?>
	<?php echo $this->Html->buttonLink("Artikel auflisten", array("controller" => "items", "action" => "index", $seller["Seller"]["id"])); ?>
</p>
...
mysql = Sql.newInstance("jdbc:mysql://${args[0]}/${args[1]}", args[2], args[3], 'com.mysql.jdbc.Driver')
...
event_id = args[4]
copy("events", events_columns, mysql) { t,c -> 'select ' + c.keySet().join(',') + ' from ' + t + ' where id=' + event_id }
